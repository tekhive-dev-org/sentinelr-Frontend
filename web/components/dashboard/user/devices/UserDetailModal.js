...
export default function UserDetailModal({ isOpen, onClose, user, onPairDevice }) {
  ...
  const controls = [
    {
      ...
      description: 'Get notified whenever an anonymous activity is performed on your SENTINELR application.',
    },
    {
      title: 'Application blocking',
      description: 'Get all the latest updates on all new content releases and product features.',
    },
    {
      title: 'Web filtering',
      description: 'Get all the latest updates on all new content releases and product features.',
    ...
    <div className={styles.modalOverlay} onClick={onClose}>
      <div className={styles.userDetailModal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.userDetailActions}>
          ...
          <button className={styles.pairDeviceBtn} onClick={() => onPairDevice && onPairDevice(user)}>
        ...
        <div className={styles.activeControlsSection}>
          ...
          <p className={styles.activeControlsSubtitle}>Below are user authorizations.</p>
