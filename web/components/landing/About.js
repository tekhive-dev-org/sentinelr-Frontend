    ...
    <section className="py-20 md:py-28 px-5 md:px-10 bg-white" id="about">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 rounded-full bg-primary-green px-8 py-4 text-base font-semibold text-white shadow-[0_4px_16px_rgba(224,112,48,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-green/90 hover:shadow-[0_6px_20px_rgba(224,112,48,0.35)]"
          >
            Create Your Account
          </Link>
        </motion.div>
