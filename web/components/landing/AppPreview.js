  ...
  const steps = [
    {
      ...
      image: '/assets/landing/signup.webp',
    ...
    },
    {
      ...
      image: '/assets/landing/3.webp',
      tip: 'Secure, encrypted connection',
    },
    {
      number: '05',
      icon: <AdminPanelSettingsIcon className="text-2xl" />,
      title: 'Grant Permissions',
      description: 'Allow location, notifications, and the requested device permissions so Sentinelr can share safety updates and keep protection features working reliably.',
      image: '/assets/landing/grant.png',
      tip: 'You stay in control of every permission',
    },
    {
      number: '06',
      ...
      image: '/assets/landing/monitor.webp',
      tip: 'Real-time status updates',
    },
  ];

  const allImages = [
    { src: '/assets/landing/signup.webp', label: 'Sign Up' },
    { src: '/assets/landing/register.webp', label: 'Add Devices & Users' },
    { src: '/assets/landing/1.1.webp', label: 'Add User/Family Member First' },
    { src: '/assets/landing/device1.webp', label: 'Add Device' },
    { src: '/assets/landing/3.webp', label: 'Generate Pairing Code' },
    { src: '/assets/landing/pair.png', label: 'Pair the mobile device' },
    { src: '/assets/landing/grant.png', label: 'Grant Permissions' },
    { src: '/assets/landing/monitor.webp', label: 'Live Location/Tracking' },
  ];
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-deep-forest mb-6">
            Get started in{' '}
            <span className="text-primary-green">6 simple steps</span>
          </h2>
