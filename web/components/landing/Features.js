          ...
          <div className="lg:sticky lg:top-28">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <Link
                  href="/signup"
                  className="group inline-flex items-center gap-2 rounded-full bg-deep-forest px-6 py-3.5 text-base font-semibold text-white shadow-[0_2px_12px_rgba(18,6,30,0.2)] transition-all duration-300 hover:-translate-y-px hover:bg-deep-forest/90 hover:shadow-[0_4px_16px_rgba(18,6,30,0.3)]"
                >
                  Get Started
