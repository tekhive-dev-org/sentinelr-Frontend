      ...
      <div className="max-w-[1200px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
        ...
        >
          ...
          >
            <Link
              href="/signup"
              className="group flex items-center gap-2 rounded-full bg-primary-green px-8 py-4 text-base font-semibold text-white shadow-[0_2px_12px_rgba(224,112,48,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-green/90 hover:shadow-[0_4px_16px_rgba(224,112,48,0.35)]"
            >
              <PersonAddIcon className="transition-transform group-hover:scale-110" />
              Create Account
            </Link>
            <Link
              href="/login"
              className="group flex items-center gap-2 rounded-full border-2 border-gray-200 bg-white px-8 py-4 text-base font-semibold text-deep-forest shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-0.5 hover:border-gray-300 hover:bg-gray-50 hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]"
            >
              <LoginIcon className="transition-transform group-hover:translate-x-0.5" />
              Log In
            </Link>
          </motion.div>
        </motion.div>
